    ...
    const sections: any = {
        ...
        csp: {
            ...
            content: [
                ...
                {
                    type: "text",
                    value: "Adicione o domínio abaixo à diretiva `connect-src` no seu arquivo `next.config.mjs`. Isso habilita o envio de logs e eventos para nossos servidores.",
                },
                {
                    type: "code",
...
<button>
  Enviar Formulário
    ...
    const data = sections[id] || sections.introdução;
